            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('Admin.subject.index') }}">Management
                                Category</a></li>
                    </ol>
                </div>
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-left">
                            @can('category-create')
                                <a class="btn btn-info" href="{{ route('Admin.subject.create') }}"> Create New
                                    Category</a>
                            @endcan
                        </div>
                    </div>
                            ...
                            <div class="table-responsive m-t-40">
                                <table id="myTable" class="table table-bordered table-striped">
                                    ...
                                    @foreach($subjects as $subject)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td class="arabic"  >{{$subject->title_ar}}</td>
                                            <td class="english" style="display: none">{{$subject->title_en}}</td>
                                            <td class="arabic"  >{{$subject->slug_ar}}</td>
                                            <td class="english" style="display: none">{{$subject->slug_en}}</td>
                                            <td>
                                                @can('subject-edit')
                                                ...
                                                @can('subject-delete')
                                                    <button class="btn btn-danger"
                                                            data-myid={{$subject->id}} data-toggle="modal"
            ...
            <div class="modal modal-danger fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{route('Admin.subject.destroy','test')}}" method="post">
                            {{method_field('delete')}}
                            {{csrf_field()}}
                            <div class="modal-body">
                                ...
                                <input type="hidden" name="subject_id" id="id" value="">

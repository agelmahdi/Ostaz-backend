            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('Admin.group.index') }}">Management
                                Group</a></li>
                    </ol>
                </div>
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-left">
                            @can('group-create')
                                <a class="btn btn-info" href="{{ route('Admin.group.create') }}"> Create New
                                    Group</a>
                            @endcan
                        </div>
                    </div>
                                ...
                                <table id="myTable" class="table table-bordered table-striped">
                                    ...
                                    @foreach($groups as $group)
                                        <tr>
                                            ...
                                            <td>{{$group->start}}</td>
                                            <td>{{$group->end}}</td>
                                            <td>{{$group->streamer->name_en}}</td>
                                            <td>{{$group->academic_year->title_en}}</td>
                                            <td>{{$group->subject->title_en}}</td>
                                            ...
                                            <td>
                                                ...
                                                @can('group-delete')
                                                    <button class="btn btn-danger"
                                                            data-myid={{$group->id}} data-toggle="modal"
                ...
                <script>
                    ...
                    $(document).ready(function () {
                        ...
                        $('#delete').on('show.bs.modal', function (event) {
                            ...
                            var modal = $(this);
                            modal.find('.modal-body #group_id').val(id);
                        });

            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('Admin.academicyears.index') }}">Category</a></li>
                                        ...
                                        <div class="form-group {{ $errors->has('streamers') ? 'focused error' : '' }}">
                                            ...
                                            <select name="streamers[]" id="streamer"
                                                ...
                                                @foreach($streamers as $streamer)
                                                    <option
                                                        @foreach($academicyear->streamers as $academicyear_streamers)
                                                        {{ $academicyear_streamers->id == $streamer->id ? 'selected' :'' }}
                                                        @endforeach

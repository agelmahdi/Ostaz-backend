    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('Admin.academicyears.index') }}">Academic Year</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('Admin.academicyears.create') }}">Create new
                                Academic Year</a></li>
                    </ol>
                </div>
            </div>
            ...
            <div class=" modal-content">
                ...
                @endif
                <form action="{{ route('Admin.academicyears.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group {{ $errors->has('streamers') ? 'focused error' : '' }}">
                                            ...
                                            <select name="streamers[]" id="tag" class="select2 m-b-10 select2-multiple select2-hidden-accessible" style="width: 100%" multiple="" data-placeholder="Choose" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-footer">
                            <a href="{{ route('Admin.academicyears.index') }}" class="btn btn-danger waves-effect">BACK</a>

                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 align-self-center">
                            ...
                            <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('Admin.permissioncategories.index') }}">Management Permissioncategories</a></li>
                            </ol>
                        </div>
                        <div class="row">
                                <div class="col-lg-12 margin-tb">
                                    ...
                                    @can('permission-create')
                                        <a class="btn btn-info" href="{{ route('Admin.permissioncategories.create') }}"> Create New PermissionCategory</a>
                                        @endcan
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <thead>
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr>
                                                                    ...
                                                                    <td>
                                                                        <form action="{{ route('Admin.permissioncategories.destroy',$permissioncategory->id) }}" method="POST">
                                                                            <a class="btn btn-info" href="{{ route('Admin.permissioncategories.show',$permissioncategory->id) }}">Show</a>
                                                                            @can('permissioncategory-edit')
                                                                            <a class="btn btn-primary" href="{{ route('Admin.permissioncategories.edit',$permissioncategory->id) }}">Edit</a>
                                                                            @endcan

            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor text-right"> {{ trans('admin.dashboard') }}</h3>
                        <ol class="breadcrumb">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table browser m-t-30 no-border">
                                    <tbody>
                                        <tr>
                                            <td style="width:40px">
                                             {!! Html::image('BackEnd/assets/images/browser/chrome-logo.png','logo', array('class' => '')) !!}
                                        </td>
                                            <td>Google Chrome</td>
                                        ...
                                        <tr>
                                            <td>
                                                 {!! Html::image('BackEnd/assets/images/browser/firefox-logo.png','logo')!!}
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                 {!! Html::image('BackEnd/assets/images/browser/safari-logo.png','logo')!!}
                                            </td>
                                            <td>Apple Safari</td>
                                        ...
                                        <tr>
                                            <td>
                                                 {!! Html::image('BackEnd/assets/images/browser/internet-logo.png','logo')!!}
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                 {!! Html::image('BackEnd/assets/images/browser/opera-logo.png','logo')!!}
                                            </td>
                                            <td>Opera mini</td>
                                            <td class="text-right">23%</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                 {!! Html::image('BackEnd/assets/images/browser/netscape-logo.png','logo')!!}
                                            </td>
                                ...
                                <div class="table-responsive m-t-20 no-wrap">
                                    <table class="table vm no-th-brd pro-of-month">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="active">
                                                <td><span class="round">
                                                     {!! Html::image('BackEnd/assets/images/users/2.jpg','user', array('width' => '50')) !!}
                                                </span></td>
                                                <td>
                            ...
                            <div class="comment-widgets">
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><span class="round">
                                         {!! Html::image('BackEnd/assets/images/users/1.jpg','user', array('width' => '50')) !!}
                                    </span></div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><span class="round">
                                         {!! Html::image('BackEnd/assets/images/users/3.jpg','user', array('width' => '50')) !!}
                                    </span></div>
                                    <div class="comment-text w-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box">
                                    ...
                                    <ul class="chat-list">
                                        ...
                                        <li>
                                            <div class="chat-img">
                                                 {!! Html::image('BackEnd/assets/images/users/2.jpg','user')!!}
                                            </div>
                                            <div class="chat-content">
                                                <h5>Bianca Doe</h5>
                                        ...
                                        <li>
                                            <div class="chat-img">
                                                 {!! Html::image('BackEnd/assets/images/users/3.jpg','user')!!}
                                            </div>
                                            <div class="chat-content">
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)">
                                         {!! Html::image('BackEnd/assets/images/users/1.jpg','user-img', array('class' => 'img-circle')) !!}
                                        <span>Varun Dhavan <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                            {!! Html::image('BackEnd/assets/images/users/2.jpg','user-img', array('class' => 'img-circle')) !!}

                                         <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                         {!! Html::image('BackEnd/assets/images/users/3.jpg','user-img', array('class' => 'img-circle')) !!}
                                         <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                         {!! Html::image('BackEnd/assets/images/users/4.jpg','user-img', array('class' => 'img-circle')) !!}
                                        <span>Arijit Sinh <small class="text-muted">Offline</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                         {!! Html::image('BackEnd/assets/images/users/5.jpg','user-img', array('class' => 'img-circle')) !!}
                                         <span>Govinda Star <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                         {!! Html::image('BackEnd/assets/images/users/6.jpg','user-img', array('class' => 'img-circle')) !!}
                                         <span>John Abraham<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                         {!! Html::image('BackEnd/assets/images/users/7.jpg','user-img', array('class' => 'img-circle')) !!}
                                        <span>Hritik Roshan<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)">
                                         {!! Html::image('BackEnd/assets/images/users/8.jpg','user-img', array('class' => 'img-circle')) !!}

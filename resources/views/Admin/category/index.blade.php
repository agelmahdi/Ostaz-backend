            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('Admin.category.index') }}">Management
                                Category</a></li>
                    </ol>
                </div>
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-left">
                            @can('category-create')
                                <a class="btn btn-info" href="{{ route('Admin.category.create') }}"> Create New
                                    Category</a>
                            @endcan
                        </div>
                    </div>
                            ...
                            <div class="table-responsive m-t-40">
                                <table id="myTable" class="table table-bordered table-striped">
                                    ...
                                    @foreach($categories as $category)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td class="arabic"  >{{$category->title_ar}}</td>
                                            <td class="english" style="display: none">{{$category->title_en}}</td>
                                            <td class="arabic"  >{{$category->slug_ar}}</td>
                                            <td class="english" style="display: none">{{$category->slug_en}}</td>

            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('Admin.category.create') }}">Create new
                                Category</a></li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="details_ar arabic">
                                            <label for="details_ar">Details Ar</label>
                                            <textarea id="mymce" name="details_ar">{{old('details_ar')}}</textarea>
                                        </div>

                                        <div class="details_en english">
                                            <label for="details_en">Details En</label>
                                            <textarea id="mymce" name="details_en" >{{old('details_ar')}}</textarea>
                                        </div>

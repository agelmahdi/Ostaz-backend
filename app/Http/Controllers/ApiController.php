...
/**
 * @OA\Post(
 *   path="/api/streamer/follower_register",
 *   summary="User Registration",
 *   tags={"Streamer Authorization"},
 *     security={{"bearerAuth":{}}},
 *   @OA\RequestBody(
...
/**
 * @OA\Get(
 *     operationId="All Data as Governorates subjects AcademicYear",
 *     path="/api/academic_subject_cities",
 *     tags={"Governorates"},
 *     @OA\Parameter(
 *         name="lang",
 *         in="query",
 ...
 *     @OA\Response(
 *     response="200",
 *      description="For Home Data as ['Governorates,subjects,AcademicYear']")
 * )
 */
//===========================End=governorate=============================================
//===========================Start=Quiz=============================================
